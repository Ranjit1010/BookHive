...
export const CategoryPage = () => {
  ...
  // useEffect hook to fetch products when the component mounts or param.catName changes
  useEffect(() => {
    const url = "http://localhost:5000/get-products?catName=" + param.catName;
    axios.get(url)
      .then((res) => {
        if (res.data.product) {
